...
### 1.1 Authentication & User Access
* Single `ADMIN` User Role with full, unrestricted operational access.
* Local login credential authentication.

### 1.2 Product & Category Master
...
### 1.3 Excel / CSV Product Dataset Import
...
### 1.4 Multi-Unit Inventory Engine & Stock Ledger
...
### 1.5 POS Counter Billing Terminal
...
### 1.7 A4 Dual-Copy Tax Invoicing
...
### 1.10 Offline Backup, Restore & Data Safety Engine
